namespace EventPlatform.Shared.Constant;

public static class LoginConstant
{
    //* Error Messages
    public static string InvalidGoogleToken = "Invalid Google token!";
    public static string GoogleEmailNotFound = "Email not found in Google token!";
    public static string GoogleLoginFailed = "Google login failed!";
    ...
    public static string GoogleLoginSuccess = "Google login successful!";
