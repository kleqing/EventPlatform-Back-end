...
public class AuthController : ControllerBase
{
    ...
    private readonly IAuthServices _authorizeServices;
    private readonly IConfiguration _configuration;

    public AuthController(IUserRepository userRepository, IAuthTokenProcess authTokenProcess, IAuthServices authorizeServices, IConfiguration configuration)
    {
